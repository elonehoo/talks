...
<template>
  ...
  >
    <div
      class="clip bg-gradient-to-r from-[#AACCFF] to-white/10"
      :style="{ 'clip-path': `polygon(${poly1})`, 'opacity': opacity }"
    />
    <div
      class="clip bg-gradient-to-l from-sky-300 to-white/10"
      :style="{ 'clip-path': `polygon(${poly2})`, 'opacity': opacity }"
    />
    <div
      class="clip bg-gradient-to-t from-white/50 to-[#AACCFF]/20"
      :style="{ 'clip-path': `polygon(${poly3})`, 'opacity': 0.22 }"
    />
  </div>
</template>
